...
if __name__ == '__main__':
    ...
    parser.add_argument('--cuda', type=str, default='0,1,3', help='If -1, use cpu; if >0 use single GPU; if 2,3,4 for multi GPUS(2,3,4)')
    ...
    # Model Configuration
    parser.add_argument('--conv_dim', type=int, default=100)
